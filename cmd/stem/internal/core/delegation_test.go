...
// operation-class set: exactly sprout.grow, passthrough.run, seed.grow and the
...
func TestDelegatedCapabilityTaxonomy(t *testing.T) {
	delegated := []string{core.CapSproutGrow, core.CapPassthroughRun, core.CapSeedGrow, core.CapGitCommit, core.CapGitPush, core.CapGitPR, core.CapGitBranch, core.CapGitStatus, core.CapGitBranchList, core.CapGitPrune}
