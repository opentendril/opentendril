...
func TestUnknownAndMalformedCredentialsResolveToNothing(t *testing.T) {
	...
	for _, presented := range []string{
		"", "   ", "not-a-credential", "tendril_refresh_", "tendril_refresh_wrong",
		"Bearer tendril_refresh_wrong", "TENDRIL_uppercase",
...
func TestMissingStoreIsTheSecureDefault(t *testing.T) {
	...
	if got := ResolvePollenFromCredential(credentials, "tendril_refresh_anything"); got != "" {
