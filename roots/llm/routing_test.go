...
func TestModelTierResolution(t *testing.T) {
	...
	t.Run("registry fallback selects lowest available cost", func(t *testing.T) {
		cases := []struct {
			...
			{name: "openai premium cap", provider: "openai", key: "OPENAI_API_KEY", tier: TierPremium, wantProv: "openai", wantModel: "gpt-5-mini", wantMode: ModeOpenAIish, wantEndpt: "/chat/completions"},
			{name: "openai standard cap", provider: "openai", key: "OPENAI_API_KEY", tier: TierStandard, wantProv: "openai", wantModel: "gpt-5-mini", wantMode: ModeOpenAIish, wantEndpt: "/chat/completions"},
			{name: "openai cheapest cap", provider: "openai", key: "OPENAI_API_KEY", tier: TierCheapest, wantProv: "openai", wantModel: "gpt-5-mini", wantMode: ModeOpenAIish, wantEndpt: "/chat/completions"},
			{name: "google premium cap", provider: "google", key: "GOOGLE_API_KEY", tier: TierPremium, wantProv: "google", wantModel: "gemini-2.5-flash", wantMode: ModeOpenAIish, wantEndpt: "/chat/completions"},
			{name: "google standard cap", provider: "google", key: "GOOGLE_API_KEY", tier: TierStandard, wantProv: "google", wantModel: "gemini-2.5-flash", wantMode: ModeOpenAIish, wantEndpt: "/chat/completions"},
			{name: "google cheapest cap", provider: "google", key: "GOOGLE_API_KEY", tier: TierCheapest, wantProv: "google", wantModel: "gemini-2.5-flash", wantMode: ModeOpenAIish, wantEndpt: "/chat/completions"},
