...
Pin **v0.3.3**. Download `install.sh` and `checksums.txt`, verify the installer,
...
curl -fsSL -o install.sh \
  https://github.com/opentendril/opentendril/releases/download/v0.3.3/install.sh
curl -fsSL -o checksums.txt \
  https://github.com/opentendril/opentendril/releases/download/v0.3.3/checksums.txt
