...
*   **The Symbiotic Nodules**: Lean microservices (ideally written in Go) that form symbioses on Branches. They act as simple MCP gateways to remote functions and external enterprise systems (e.g. GCP, Datadog).
